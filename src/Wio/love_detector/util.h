...
#define START_MESSAGE          "Hello and Welcome to The Love Detector.\n\
                                Press the left button to begin. While in test, \
                                press the left button to stop the test or the \
                                middle button to change to the next question. \
                                Press the right button for help."
