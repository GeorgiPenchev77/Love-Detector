...
unsigned int heart_rate1,heart_rate2;
...
*/
  ...
  arrayInit1();  //initialize the data array with 0s
  arrayInit2();
  /*
...
void sum1() {
  if (data_effect1) {
    ...
    clear();
    printNewMessage(10,10, result_message + String(heart_rate1));
  }
  data_effect1 = true;
}
...
void sum2() {
  if (data_effect2) {
    ...
    printNewMessage(150,150, result_message + String(heart_rate2));
  }
  data_effect2 = true;
}
